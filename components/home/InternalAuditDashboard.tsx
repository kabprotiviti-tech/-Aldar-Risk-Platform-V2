  ...
  return (
    <div style={{ padding: '20px 28px', display: 'flex', flexDirection: 'column', gap: 14 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(170px, 1fr))', gap: 10 }}>
        ...
        <KPI label="Open Findings" value={openFindings.length} accent="#0B6E5B" sub="mitigation actions" sparkSeed={17} />
      ...
      <Section title="Assurance Coverage Gap (proxy)" subtitle="Risks with widest gap between inherent score and control count" accent="#0B6E5B" icon={<Search size={14} />} cta={<Link href="/risk-register" style={ctaSmall}>Open register →</Link>}>
