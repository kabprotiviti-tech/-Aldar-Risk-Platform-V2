...
export const controls: Control[] = [
...

  {
    ...
    description: 'ABC Education tracks ADEK regulatory submission deadlines monthly; any submission >5 days late is escalated to the Education CEO.',
    process: 'Governance & Compliance',
    frequency: 'Monthly',
    owner: 'ABC Education CEO',
    linkedRiskId: 'R-005',
    linkedRiskTitle: 'ABC Education Regulatory Compliance — ADEK Curriculum Changes',
    portfolio: 'education',
    controlType: 'Preventive',
...

  {
    ...
    description: 'ABC Investment Properties reviews FM partner SLA performance quarterly; CSAT <80% triggers a formal performance improvement notice (PIN).',
    process: 'Governance & Compliance',
    frequency: 'Quarterly',
